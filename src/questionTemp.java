...
public class QuestionTemp {
        ...
        String multipleChoiceAnswers[][] = {
                        ...
                        { "Size may not be required. It changes the size dynamically", "No index required",
                                        "name[1] = book" },
                        { ".js", ".txt", ".class", ".java" },
        ...
        String CorrectAnswers[] = { "Java is a platform-independent programming language", "JDK",
                        ...
                        "int[] A = {1, 2, 3}", "When it doesn’t make sense to have objects of that class", "java.lang",
                        "s1 == s2",
                        "Book(Book b) {}", "3.0", "static", "Instance variables", "False", "False", "True", "True",
                        "False",
                        "False", "True" };
        ...
        void questionPopup(Player player) {
                ...
                response = JOptionPane.showOptionDialog(null, Question[counter], "You hear a voice from above ask...",
                                0,
                                JOptionPane.QUESTION_MESSAGE, null, multipleChoiceAnswers[counter],
                                multipleChoiceAnswers[counter]);
