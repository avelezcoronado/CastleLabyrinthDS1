...
private String multipleChoiceAnswers[][]= {
        ...
        {".txt.js",".class",".java"},
        {"An object is what classes instantiated are from","An object is an instance of a class","An object is a variable"},
        {"The use of consistent coding conventions","The organization of components interacting to achieve a coherent, common behavior","The use of inheritance to achieve polymorphic behavior"},
        ...
        {"To prevent developers from further extending the class","When it does not make sense to have objects of that class"},
