...
public class insideRoom {
        ...
        void room(Player player) {
                        ...
                        if (damageOrKill == 0) {
                                attackBtn.addActionListener(new java.awt.event.ActionListener() {
                                        public void actionPerformed(java.awt.event.ActionEvent evt) {
                                                JOptionPane.showMessageDialog(null,
                                                                "You fought the " + monsters[monsterChooser]+ " and won, but took " + damage[monsterChooser]+" life");
                ...
                runBtn.addActionListener(new java.awt.event.ActionListener() {
                        ...
                        runBtn.addActionListener(new java.awt.event.ActionListener() {
                                public void actionPerformed(java.awt.event.ActionEvent evt) {
                                JOptionPane.showMessageDialog(null, "The " + helpers[friendChooser] + " gave you "+heal[friendChooser]+"life! You thank him and move on");
