...
public class gameIntroduction {
    ...
    void introframe() {
        ...
        jTextArea2.setText(
                "Once upon a time, was walking in the night in his village. A terrible dragon \nswooped down and grabbed him with his claws and took him to a castle in another kingdom in the distance, the dragon threw him towards the top of the castle on the terrace and the dragon vanished into the darkness...");
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(enterName, javax.swing.GroupLayout.DEFAULT_SIZE,
